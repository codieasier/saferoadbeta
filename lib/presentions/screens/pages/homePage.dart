  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor:  Color(0xFF26396B),
       bottomNavigationBar: CurvedNavigationBar(items :items,color:const Color(0xFF26396B),
        backgroundColor: const Color(0xFF6A7B94),animationDuration: Duration(milliseconds: 200),
        height: 70,),
        ...
        body: SafeArea(child: Container(
          ...
          children: [Container(
            ...
            child:Stack(children: [
              Image.asset('assets/images/softlight.png',width: double.infinity,height: 120,)
              ,Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [CircleAvatar(child: Image.asset('assets/images/driverimage.png')),
                IconButton(
              ...
              Row(mainAxisAlignment: MainAxisAlignment.end,
                ...
                children: [
                  ...
                  RichText(
                    text: TextSpan(
                        children: <TextSpan>[
                          TextSpan(text: 'مرحبًا بك '+username,style: AppTextStyles.heading1)
          ...
          Expanded(
            child: SingleChildScrollView(child:
              Column(
                ...
                children: [HomeCard(content:

                Column(
                children: [
                SvgPicture.asset('assets/icons/speedometer-speed-fast_svgrepo.com.svg', height: 40,width: 50,),
                  Text('قيادتك هذا الأسبوع كانت آمنة بنسبة',style: AppTextStyles.heading2,)
